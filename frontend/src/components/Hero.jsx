  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
          <div className='text-center mb-6'>
              ...
              <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto max-sm:text-xs text-gray-600'>Transfrom your content creation with our suite of premium Ai tools. Write articles, generate images, and enhace your workflow.</p>
          </div>
          ...
          <div className='flex items-center gap-4 mt-8 mx-auto text-gray-600'>
              <img src={assets.user_group} alt="user group" className='h-8'/> Trusted by 50K+ users
           </div>
    </div>
  )
}
